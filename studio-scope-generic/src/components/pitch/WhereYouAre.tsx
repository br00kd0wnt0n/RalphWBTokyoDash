    ...
    <section>
      <div className="mb-6">
        ...
        <p className="text-text-secondary text-sm max-w-2xl">
          Social presence as of December 2025. The foundation for everything that follows.
        </p>
      </div>
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-xs text-text-dim hover:text-accent transition-colors mb-4"
      >
