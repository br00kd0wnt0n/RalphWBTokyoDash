  ...
  <header className="sticky top-0 z-50 bg-bg-secondary/95 backdrop-blur-md border-b border-border">
    <div className="max-w-dashboard mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <nav className="flex items-center gap-1">
        <button
          onClick={onInfoClick}
          className="px-2 py-1.5 text-text-dim hover:text-accent hover:bg-bg-tertiary/50 rounded-inner transition-colors duration-200"
        ...
        <button
          ...
          className="px-3 py-1.5 text-xs text-text-dim hover:text-accent hover:bg-bg-tertiary/50 rounded-inner transition-colors duration-200 flex items-center gap-1.5"
        >
