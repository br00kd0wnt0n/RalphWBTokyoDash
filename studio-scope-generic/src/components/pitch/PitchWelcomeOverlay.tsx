...
const SECTIONS = [
  {
    icon: BarChart3,
    label: 'Where You Are',
    description: 'A snapshot of the client\'s social presence today: 535K followers across four platforms, with Instagram as the primary growth engine.',
  },
  {
    icon: Sliders,
  ...
  },
  {
    ...
    description: '12-month forecast against three KPIs: +100K followers, +10% engagement YoY, and 50 strategic posts per month. Updates dynamically as you adjust the strategy.',
  },
];
    ...
    <div className="relative w-full max-w-xl max-h-[90vh] overflow-y-auto bg-bg-secondary border border-border rounded-card p-8">
      ...
      <div className="border-t border-border pt-6 mb-6">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-4">
          This pitch tool maps Ralph's strategy directly to three core KPIs. Adjust the audience mix, platform allocation, and campaign calendar, then see projected impact on follower growth, engagement, and content volume in real time.
        </p>

        {/* KPI badges */}
        <div className="flex gap-2 mb-6">
          <span className="px-3 py-1.5 bg-bg-tertiary border border-border rounded-inner text-xs text-accent font-mono">
            +100K Followers
          </span>
          <span className="px-3 py-1.5 bg-bg-tertiary border border-border rounded-inner text-xs text-accent font-mono">
            +10% Engagement
