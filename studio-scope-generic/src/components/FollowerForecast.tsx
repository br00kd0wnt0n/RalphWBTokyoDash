    ...
    <section>
      ...
      <div className="bg-bg-secondary border border-border rounded-card p-5 mb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <p className="text-accent text-sm font-mono font-semibold">{formatGrowth(totalGrowth)}</p>
        </div>
        <div className="w-full h-3 bg-bg-tertiary rounded-full overflow-hidden">
          <div
            ...
            style={{
              ...
              backgroundColor: progressPct >= 100 ? '#4ade80' : '#E91E8C',
            }}
          />
        </div>
      </div>
          ...
          <tbody>
            {growthTable.map((row) => (
              <tr key={row.label} className="border-b border-border/50 hover:bg-bg-tertiary/30">
                ...
                <td className="py-2 pl-3 text-right text-accent font-mono font-semibold">+{formatNumber(row.total)}</td>
              </tr>
            ))}
          </tbody>
          <tfoot>
            <tr className="border-t border-accent/30">
              ...
              <td className="py-3 pl-3 text-right text-accent font-mono font-bold text-sm">
