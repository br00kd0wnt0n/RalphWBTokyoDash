  ...
  return (
    <section>
      <SectionHeader
        moduleNumber={1}
        title="State of Play"
        subtitle="Where the client stands today and how they got here. 30 months of social growth data across four platforms."
        id="module-1"
      />
            ...
            <div className="flex flex-col gap-3 w-full lg:w-auto">
              ...
              <div className="pt-2 border-t border-border mt-1">
                <div className="flex items-center justify-between px-2.5">
                  ...
                  <span className="text-accent text-sm font-mono font-semibold">{formatCompact(CURRENT_FOLLOWERS.total)}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="bg-bg-secondary border border-border rounded-card p-5">
          <p className="text-accent text-xs font-mono uppercase tracking-widest mb-2">Insight</p>
