        ...
        <div className="bg-bg-secondary border border-border rounded-card p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={yoyData} margin={{ top: 30, right: 20, left: 10, bottom: 0 }}>
              ...
              <Line type="monotone" dataKey="eng2025" name="2025" stroke="#E91E8C" strokeWidth={2} dot={false} animationDuration={800} />
      ...
      <div className="bg-bg-secondary border border-border rounded-card p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-bg-tertiary rounded-inner">
            ...
            <p className="text-text-secondary text-xs leading-relaxed">
              Casual audiences engage at lower per-post rates than core fans. The strategy prioritizes total engagement growth over rate maintenance, which is the more meaningful business metric for the client.
            </p>
          </div>
        </div>
      </div>
