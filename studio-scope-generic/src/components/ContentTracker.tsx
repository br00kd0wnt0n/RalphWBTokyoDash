    ...
    <section>
      ...
      <div className="bg-bg-secondary border border-border rounded-card p-6 mb-6">
        ...
        <ResponsiveContainer width="100%" height={320}>
          <BarChart data={postData} margin={{ top: 30, right: 20, left: 10, bottom: 0 }}>
            ...
            <ReferenceLine y={50} stroke="#E91E8C" strokeDasharray="6 3" label={{ value: 'Target: 50', position: 'right', fontSize: 10, fill: '#E91E8C' }} />
            {PLATFORMS.map(p => (
      ...
      <div className="bg-bg-secondary border border-border rounded-card p-6">
        ...
        <div className="mt-6 p-4 bg-bg-tertiary rounded-inner">
          <p className="text-accent text-xs font-mono uppercase tracking-widest mb-2">Strategic Note</p>
          <p className="text-text-secondary text-xs leading-relaxed">
            The client currently publishes ~{avgPosts} posts/month across all platforms. The 50 posts/month KPI is not a volume reduction target. It is a reframing: shifting from quantity-driven posting to strategic, audience-specific content allocation where every post serves a measurable purpose.
          </p>
        </div>
      </div>
    </section>
