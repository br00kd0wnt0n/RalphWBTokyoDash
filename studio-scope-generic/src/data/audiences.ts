...
export const SEGMENTS: Record<string, SegmentDefinition> = {
  core: {
    id: 'core',
    label: 'Core Fans',
    description: 'Dedicated brand enthusiasts who actively engage with franchise content. Primarily domestic audience aged 15-45 with deep knowledge of the IP.',
  ...
  light: {
    id: 'light',
    label: 'Light Fans',
    description: 'Casual followers of the franchise. Entertainment seekers aged 18-35 who enjoy themed experiences but are not deeply invested in lore. High potential for FOMO-driven content.',
  ...
  tourist: {
    ...
    description: 'International visitors planning trips to the venue. Motivated by visual spectacle and practical visit information. Multilingual content essential.',
...
export const AUDIENCE_PRESETS: AudiencePresetConfig[] = [
  ...
  },
  {
    id: 'tourism_push',
    label: 'Tourism Push',
    description: 'Maximise inbound visitor reach with multilingual content. Strongest social-to-attendance conversion but requires multilingual content pipeline.',
