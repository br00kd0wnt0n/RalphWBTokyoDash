...
export const ASSUMPTIONS: Assumption[] = [
  ...
  },
  {
    ...
    unit: 'multiplier per post',
    confidence: 'low',
    source: 'Industry benchmark (entertainment venues). Needs validation with client-specific TikTok posting experiments.',
    editable: true,
  },
  {
  ...
  },
  {
    ...
    unit: 'multiplier',
    confidence: 'medium',
    source: 'Based on Nov 2024 IG spike (+19.5K during Winter Wonderland). Applied additively with seasonal factor.',
    editable: true,
  },
  {
  ...
  // --- Confidence Bands ---
  {
    ...
    confidence: 'medium',
    source: 'Assumes viral moments, strong campaign execution, and/or franchise TV series boost. Static band; does not scale with input uncertainty.',
    editable: true,
  },
  {
