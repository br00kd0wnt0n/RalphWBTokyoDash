...
const RECOMMENDATIONS = [
  ...
  },
  {
    ...
    impact: 'High',
    impactColor: '#4ade80',
    observation: 'Current content is primarily single-language. With 42.4M inbound tourists projected for 2025 (and growing), WBSTT is leaving significant international reach on the table, particularly on Instagram and YouTube where tourist audiences are concentrated.',
